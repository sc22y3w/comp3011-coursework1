...
# 	def test_login_api_accepts_post_json(self):
# 		response = self.client.post(
# 			'/api/auth/login/',
# 			data=json.dumps({'username': 'ash', 'password': 'pikachu123'}),
...
# 		response = self.client.post(
# 			'/api/auth/login/',
# 			data=json.dumps({'username': 'ash', 'password': 'wrong-password'}),
# 			content_type='application/json',
# 		)
...
# class ProtectedApiAuthTests(TestCase):
# 	def setUp(self):
# 		self.grass = PokemonType.objects.create(name='grass')
# 		self.water = PokemonType.objects.create(name='water')
# 		self.pokemon = []
# 		for i in range(1, 7):
# 			pokemon = Pokemon.objects.create(
# 				name=f'Pokemon {i}',
...
# 				speed=50,
# 			)
# 			pokemon.type.set([self.grass if i % 2 else self.water])
# 			self.pokemon.append(pokemon)

# 		self.team = PokemonTeam.objects.create(
# 			name='Existing Team',
# 			pokemon_1=self.pokemon[0],
# 			pokemon_2=self.pokemon[1],
# 			pokemon_3=self.pokemon[2],
# 			pokemon_4=self.pokemon[3],
# 			pokemon_5=self.pokemon[4],
# 			pokemon_6=self.pokemon[5],
# 		)
...
# 	def test_create_team_api_requires_auth(self):
# 		payload = {
...
# 	def test_edit_team_api_requires_auth(self):
# 		payload = {
# 			'name': 'Updated Name',
# 			'pokemon_1': self.pokemon[5].id,
# 			'pokemon_2': self.pokemon[4].id,
# 			'pokemon_3': self.pokemon[3].id,
# 			'pokemon_4': self.pokemon[2].id,
# 			'pokemon_5': self.pokemon[1].id,
# 			'pokemon_6': self.pokemon[0].id,
# 		}

# 		response = self.client.put(
# 			f'/api/team/{self.team.id}/edit/',
# 			data=json.dumps(payload),
# 			content_type='application/json',
# 		)
...
# 	def test_delete_team_api_requires_auth(self):
# 		response = self.client.delete(f'/api/team/{self.team.id}/delete/')
